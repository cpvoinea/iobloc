...
namespace iobloc.Native
{
    public static class Console
    {
        ...
        public static string Title
        {
            ...
            set
            {
                ConsolePal.Title = value ?? throw new System.ArgumentNullException(nameof(value));
            }
        }
        ...
        public static Stream OpenStandardInput(int bufferSize)
        {
            ...
            if (bufferSize < 0)
            {
                throw new System.ArgumentOutOfRangeException(nameof(bufferSize), SR.ArgumentOutOfRange_NeedNonNegNum);
            }
