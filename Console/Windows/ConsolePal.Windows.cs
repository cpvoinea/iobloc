...
namespace iobloc.Native.Windows
{
    ...
    {
        private static System.IntPtr InvalidHandleValue => new System.IntPtr(-1);
        ...
        {
            System.IntPtr handle = Interop.Kernel32.GetStdHandle(handleType);
        ...
        private static unsafe bool ConsoleHandleIsWritable(System.IntPtr outErrHandle)
        {
            ...
            byte junkByte = 0x41;
            int r = Interop.Kernel32.WriteFile(outErrHandle, &junkByte, 0, out int bytesWritten, System.IntPtr.Zero);
        ...
        private static bool IsHandleRedirected(System.IntPtr handle)
        {
        ...
        public static bool NumberLock
        {
            get
            {
                ...
                catch (System.Exception)
                {
                    ...
                    // In case of System.Exception we simply throw PNSE
                ...
                while (true)
                {
                    ...
                    if (!r)
                    {
                        ...
                        if (errorCode == Interop.Errors.ERROR_INVALID_HANDLE)
                            throw new System.InvalidOperationException(SR.InvalidOperation_ConsoleKeyAvailableOnFile);
                ...
                { // We did NOT have a previous keystroke with repeated characters:
                    ...
                    while (true)
                    {
                        ...
                        if (!r || numEventsRead == 0)
                        {
                            ...
                            throw new System.InvalidOperationException(SR.InvalidOperation_ConsoleReadKeyOnFile);
                        }
        ...
        public static bool TreatControlCAsInput
        {
            get
            {
                System.IntPtr handle = InputHandle;
        ...
        public static ConsoleColor BackgroundColor
        {
            get
            {
                Interop.Kernel32.CONSOLE_SCREEN_BUFFER_INFO csbi = GetBufferInfo(false, out bool succeeded);
                return succeeded ?
        ...
        public static void ResetColor()
        {
            ...
            {
                GetBufferInfo(false, out bool succeeded);
                if (!succeeded)
        ...
        public static int CursorSize
        {
            get
            {
                if (!Interop.Kernel32.GetConsoleCursorInfo(OutputHandle, out Interop.Kernel32.CONSOLE_CURSOR_INFO cci))
                    throw Win32Marshal.GetExceptionForWin32Error(Marshal.GetLastWin32Error());
            ...
            set
            {
                ...
                if (value < 1 || value > 100)
                    throw new System.ArgumentOutOfRangeException(nameof(value), value, SR.ArgumentOutOfRange_CursorSize);
        ...
        public static void Beep(int frequency, int duration)
        {
            ...
            if (frequency < MinBeepFrequency || frequency > MaxBeepFrequency)
                throw new System.ArgumentOutOfRangeException(nameof(frequency), frequency, string.Format(SR.ArgumentOutOfRange_BeepFrequency, MinBeepFrequency, MaxBeepFrequency));
            if (duration <= 0)
                throw new System.ArgumentOutOfRangeException(nameof(duration), duration, SR.ArgumentOutOfRange_NeedPosNum);
            ...
            ConsoleColor sourceBackColor)
        {
            if (sourceForeColor < ConsoleColor.Black || sourceForeColor > ConsoleColor.White)
                throw new System.ArgumentException(SR.Arg_InvalidConsoleColor, nameof(sourceForeColor));
            if (sourceBackColor < ConsoleColor.Black || sourceBackColor > ConsoleColor.White)
                throw new System.ArgumentException(SR.Arg_InvalidConsoleColor, nameof(sourceBackColor));

            Interop.Kernel32.CONSOLE_SCREEN_BUFFER_INFO csbi = GetBufferInfo();
            Interop.Kernel32.COORD bufferSize = csbi.dwSize;
            if (sourceLeft < 0 || sourceLeft > bufferSize.X)
                throw new System.ArgumentOutOfRangeException(nameof(sourceLeft), sourceLeft, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            if (sourceTop < 0 || sourceTop > bufferSize.Y)
                throw new System.ArgumentOutOfRangeException(nameof(sourceTop), sourceTop, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            if (sourceWidth < 0 || sourceWidth > bufferSize.X - sourceLeft)
                throw new System.ArgumentOutOfRangeException(nameof(sourceWidth), sourceWidth, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            if (sourceHeight < 0 || sourceTop > bufferSize.Y - sourceHeight)
                throw new System.ArgumentOutOfRangeException(nameof(sourceHeight), sourceHeight, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            ...
            if (targetLeft < 0 || targetLeft > bufferSize.X)
                throw new System.ArgumentOutOfRangeException(nameof(targetLeft), targetLeft, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            if (targetTop < 0 || targetTop > bufferSize.Y)
                throw new System.ArgumentOutOfRangeException(nameof(targetTop), targetTop, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
            ...
            for (int i = sourceTop; i < sourceTop + sourceHeight; i++)
            {
                ...
                r = Interop.Kernel32.FillConsoleOutputCharacter(OutputHandle, sourceChar, sourceWidth, writeCoord, out int numWritten);
        ...
        public static void Clear()
        {
            ...
            System.IntPtr hConsole = OutputHandle;
            ...
            success = Interop.Kernel32.FillConsoleOutputCharacter(hConsole, ' ',
                conSize, coordScreen, out int numCellsWritten);
            if (!success)
                throw Win32Marshal.GetExceptionForWin32Error(Marshal.GetLastWin32Error());
        ...
        public static void SetCursorPosition(int left, int top)
        {
            ...
            if (!Interop.Kernel32.SetConsoleCursorPosition(hConsole, coords))
            {
                ...
                if (left >= csbi.dwSize.X)
                    throw new System.ArgumentOutOfRangeException(nameof(left), left, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
                if (top >= csbi.dwSize.Y)
                    throw new System.ArgumentOutOfRangeException(nameof(top), top, SR.ArgumentOutOfRange_ConsoleBufferBoundaries);
        ...
        public static void SetBufferSize(int width, int height)
        {
            ...
            if (width < srWindow.Right + 1 || width >= short.MaxValue)
                throw new System.ArgumentOutOfRangeException(nameof(width), width, SR.ArgumentOutOfRange_ConsoleBufferLessThanWindowSize);
            if (height < srWindow.Bottom + 1 || height >= short.MaxValue)
                throw new System.ArgumentOutOfRangeException(nameof(height), height, SR.ArgumentOutOfRange_ConsoleBufferLessThanWindowSize);
        ...
        public static unsafe void SetWindowPosition(int left, int top)
        {
            ...
            if (left < 0 || newRight > csbi.dwSize.X - 1 || newRight < left)
                throw new System.ArgumentOutOfRangeException(nameof(left), left, SR.ArgumentOutOfRange_ConsoleWindowPos);
            int newBottom = top + srWindow.Bottom - srWindow.Top;
            if (top < 0 || newBottom > csbi.dwSize.Y - 1 || newBottom < top)
                throw new System.ArgumentOutOfRangeException(nameof(top), top, SR.ArgumentOutOfRange_ConsoleWindowPos);
        ...
        {
            if (width <= 0)
                throw new System.ArgumentOutOfRangeException(nameof(width), width, SR.ArgumentOutOfRange_NeedPosNum);
            if (height <= 0)
                throw new System.ArgumentOutOfRangeException(nameof(height), height, SR.ArgumentOutOfRange_NeedPosNum);
            ...
            if (csbi.dwSize.X < csbi.srWindow.Left + width)
            {
                if (csbi.srWindow.Left >= short.MaxValue - width)
                    throw new System.ArgumentOutOfRangeException(nameof(width), string.Format(SR.ArgumentOutOfRange_ConsoleWindowBufferSize, short.MaxValue - width));
            ...
            if (csbi.dwSize.Y < csbi.srWindow.Top + height)
            {
                if (csbi.srWindow.Top >= short.MaxValue - height)
                    throw new System.ArgumentOutOfRangeException(nameof(height), string.Format(SR.ArgumentOutOfRange_ConsoleWindowBufferSize, short.MaxValue - height));
            ...
            if (!Interop.Kernel32.SetConsoleWindowInfo(OutputHandle, true, &srWindow))
            {
                ...
                Interop.Kernel32.COORD bounds = Interop.Kernel32.GetLargestConsoleWindowSize(OutputHandle);
                if (width > bounds.X)
                    throw new System.ArgumentOutOfRangeException(nameof(width), width, string.Format(SR.ArgumentOutOfRange_ConsoleWindowSize_Size, bounds.X));
                if (height > bounds.Y)
                    throw new System.ArgumentOutOfRangeException(nameof(height), height, string.Format(SR.ArgumentOutOfRange_ConsoleWindowSize_Size, bounds.Y));
        ...
        {
            if ((((int)color) & ~0xf) != 0)
                throw new System.ArgumentException(SR.Arg_InvalidConsoleColor);
        ...
        {
            return GetBufferInfo(true, out bool unused);
        }
        ...
        private static Interop.Kernel32.CONSOLE_SCREEN_BUFFER_INFO GetBufferInfo(bool throwOnNoConsole, out bool succeeded)
        {
            ...
            if (!Interop.Kernel32.GetConsoleScreenBufferInfo(outputHandle, out Interop.Kernel32.CONSOLE_SCREEN_BUFFER_INFO csbi) &&
        ...
        private sealed class WindowsConsoleStream : ConsoleStream
        {
            ...
            internal WindowsConsoleStream(System.IntPtr handle, FileAccess access, bool useFileAPIs)
                : base(access)
            {
                Debug.Assert(handle != System.IntPtr.Zero && handle != InvalidHandleValue, "ConsoleStream expects a valid handle!");
                _handle = handle;
            ...
            public override int Read(byte[] buffer, int offset, int count)
            {
                ...
                int errCode = ReadFileNative(_handle, buffer, offset, count, _isPipe, out int bytesRead, _useFileAPIs);
            ...
            {
                if (_handle == System.IntPtr.Zero) throw Error.GetFileNotOpen();
                base.Flush();
            }
            ...
            private static unsafe int ReadFileNative(System.IntPtr hFile, byte[] bytes, int offset, int count, bool isPipe, out int bytesRead, bool useFileAPIs)
            {
                ...
                if (bytes.Length - offset < count)
                    throw new System.IndexOutOfRangeException(SR.IndexOutOfRange_IORaceCondition);
                ...
                fixed (byte* p = &bytes[0])
                {
                    if (useFileAPIs)
                    {
                        readSuccess = (0 != Interop.Kernel32.ReadFile(hFile, p + offset, count, out bytesRead, System.IntPtr.Zero));
                    }
                    else
                    {
                        // If the code page could be Unicode, we should use ReadConsole instead, e.g.
                        readSuccess = Interop.Kernel32.ReadConsole(hFile, p + offset, count / BytesPerWChar, out int charsRead, System.IntPtr.Zero);
            ...
            private static unsafe int WriteFileNative(System.IntPtr hFile, byte[] bytes, int offset, int count, bool useFileAPIs)
            {
                Debug.Assert(offset >= 0, "offset >= 0");
                Debug.Assert(count >= 0, "count >= 0");
                Debug.Assert(bytes != null, "bytes != null");
                ...
                fixed (byte* p = &bytes[0])
                {
                    if (useFileAPIs)
                    {
                        writeSuccess = (0 != Interop.Kernel32.WriteFile(hFile, p + offset, count, out int numBytesWritten, System.IntPtr.Zero));
                    ...
                    else
                    {
                        ...
                        writeSuccess = Interop.Kernel32.WriteConsole(hFile, p + offset, count / BytesPerWChar, out int charsWritten, System.IntPtr.Zero);
